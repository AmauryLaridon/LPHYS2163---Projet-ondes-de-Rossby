...
xvalues, yvalues = np.meshgrid(np.arange(0,Lx,delta_s),np.arange(0,Ly,delta_s)) #Crée deux tableaux de 30 pour 60 (si delta_s = 200kml), l'un avec les valeurs de x et l'autre de y
